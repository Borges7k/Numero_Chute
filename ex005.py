...
while jogar == True:
    ...
    try:
        ...
        if resposta == 1:
            ...
            sleep(1)
            print(
                'Vou sortear um número de 1 a 100, você tem 10 tentativas para acertar, você recebe pontos de acordo com quantas tentativas você usou para acertar, Boa Sorte!')
            sleep(1)
            for i in range(5):
                print('=>' * 15)
                sleep(1)
            ...
            while comparacao == False:
                ...
                if comparacao == False and pontuacao_rodada > 0:
                    ...
                    print(
                        f'Parabéns, você ganhou {pontuacao_rodada} pontos nessa rodada, seu placar geral agora é {pontuacao_geral}')
                    for i in range(5):
                        print('=>' * 15)
                        sleep(1)
